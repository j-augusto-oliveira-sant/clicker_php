...
<body>
		...
		<div class="container-fluid">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item"><a class="navbar-brand text-uppercase fs-1 fw-bolder"
						href="{% url 'index' %}" id="brand_logo">Cult of Dagon</a></li>
            ...
            <ul id='profile_icon' class="navbar-nav ms-auto">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                            <li><a class="dropdown-item" href="{% url 'accounts:profile_view' profile.pk %}">Profile</a></li>
    ...
    <div>
        <div style='float: left; margin-left: 50px; margin-top: 40px;'>
            <a class='fishbtn  fs-1' onclick='fisherman_click()' name='fisherman' id='brand_logo' href="#">1 <img src="img/fisherman.png" alt="" width='200px' height="200px"></a>
        </div>
